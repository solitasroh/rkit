...
// NOTE (bkit-gstack-sync-v2 / Cycle 1, C4): common.js was removed in bkit
// v2.1.0 S1 cleanup; the broken getCommon() shim was deleted here too.
...
async function orchestrateSkillPre(skillName, args, context) {
  ...
  if (config['task-template'] && args.feature) {
    ...
    if (currentIndex > 0) {
      ...
      const pdcaStatus = pdcaStatus.getPdcaStatusFull();
